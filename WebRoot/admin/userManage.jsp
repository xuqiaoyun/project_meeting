...
<script type="text/javascript">
	...
	function deleteUser() {
		...
		$.messager.confirm("系统提示", "您确认要删除这<font color=red>"
			...
			if (r) {
				$.post("${pageContext.request.contextPath}/userapi/delete", {
					id : ids
				}, function(result) {
					if (result) {
	...
	function openUserAddDialog() {
		...
		url = "${pageContext.request.contextPath}/userapi/add";
	}

	/* 点击保存用户按钮 */
	function saveUser() {
		console.log("我到这里来了" + url);
		$("#fm").form( "submit", {
			url : url ,
			onSubmit : function() {
	...
	function openUserModifyDialog() {
		...
		url = "${pageContext.request.contextPath}/userapi/update/" + row.id;
	}
...
<body style="margin:1px;">
	<table id="dg" title="用户管理" class="easyui-datagrid" fitColumns="true"
		...
		data-options="url:'${pageContext.request.contextPath}/userapi/show',method:'get'"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="password" width="100" align="center" hidden="true">密码</th>
