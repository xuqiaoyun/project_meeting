...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			<h1 style="background:#fc7e31">管理员登陆</h1>
			<form id="loginForm" method="post" action="${pageContext.request.contextPath}/user_login.action" onsubmit="return checkForm()">
				<table>
					...
					<tr>
						...
						<td><label class="ui-green"><input type="submit" name="submit" value="立即登录" style="background:#fc7e31"/></label>&nbsp;&nbsp;<font id="error"  color="red">${error }</font></td>
					</tr>
				</table>
			</form>
		</div>
